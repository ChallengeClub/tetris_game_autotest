...
class Game_Manager(QMainWindow):
    ...
    def initUI(self):
        ...
        self.center()
        self.setWindowTitle('Tetris & Cute Strawberry')
        self.tboard.setStyleSheet(" background-image: url(./forest.png)")
        self.sidePanel.setStyleSheet(" background-image: url(./forests.png)")
        self.statusbar.setStyleSheet(" background-color: #907C58")
        self.show()
...
def drawSquare(painter, x, y, val, s):
    ...
    pixmap1=QPixmap("./str.gif")
    painter.drawPixmap(x+1, y+1, s-2, s-2, pixmap1)
