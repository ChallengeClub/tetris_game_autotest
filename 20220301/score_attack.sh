...
function do_game(){
    ...
    # prepare
    local COMMAND="source ~/venvtest/bin/activate && cd ~/tetris && python3 start.py -l ${LEVEL} -t ${GAME_TIME} -r ${RANDOM_SEED} -u ${UNAME} -f ${LOGFILE}"
...
do_game 2 "isshy-you" 500 150 100 50 200 300
